    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username != null && password != null) {  //일반회원
                    editor.clear();
                    editor.commit();
                    startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT));
                } else if(username !=null && password == null){ //카카오 회원
        ...
        memberdelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username != null && password == null) {
                    ...
                    editor.commit();
                    startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT));
                } else if (username != null && password != null) {  // 일반 회원
                    Call<Member> call = memberService.delete(username);
                    call.enqueue(new Callback<Member>() {
                        @Override
                        public void onResponse(Call<Member> call, Response<Member> response) {
