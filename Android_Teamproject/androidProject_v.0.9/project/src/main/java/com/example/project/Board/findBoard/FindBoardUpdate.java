...
import com.example.project.databinding.ActivityFindBoardUpdateBinding;
...
public class FindBoardUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_board_update);binding = ActivityFindBoardUpdateBinding.inflate(getLayoutInflater());
