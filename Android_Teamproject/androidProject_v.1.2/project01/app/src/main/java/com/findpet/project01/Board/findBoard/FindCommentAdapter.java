...
public class FindCommentAdapter extends RecyclerView.Adapter<FindCommentAdapter.ViewHolderCmt> {

    List<Comment> commentList;

    public FindCommentAdapter(List<Comment> commentList) {
    ...
    @NonNull
    @Override
    public FindCommentAdapter.ViewHolderCmt onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_comment, parent, false);
        return new ViewHolderCmt(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FindCommentAdapter.ViewHolderCmt holder, int position) {
        Comment comment = commentList.get(position);
        holder.txmemberid.setText(comment.getMember().getName());
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("수정하기", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Call<Comment> call = commentService.update(comment1);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dlg2.setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        CommentService commentService = CommentClient.getInstance().getCommentService();
                        Call<Void> call = commentService.deleteById(comment.getCommentId());
