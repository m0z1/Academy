...
public class Missyou_Insert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSave.setOnClickListener(view -> {
         ...
         /*   missyouBoard.setPetname(binding.petname.getText().toString());
            missyouBoard.setBreed(binding.breed.getText().toString());
            missyouBoard.setBreed(binding.petage.getText().toString());
            missyouBoard.setContent(binding.content.getText().toString());
            missyouBoard.setPetage(binding.petage.getText().toString());
            missyouBoard.setPetcharacter(binding.petcharacter.getText().toString());
            missyouBoard.setMissingaddr(binding.missingaddr.getText().toString());
            missyouBoard.setPetcategory(binding.petcategory.getSelectedItem().toString());*/
/*
            if(binding.petgenderHe.isChecked()){
