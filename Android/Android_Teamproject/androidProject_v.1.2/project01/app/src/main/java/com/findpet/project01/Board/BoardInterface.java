...
public interface BoardInterface {
    ...
    Call<FindBoard> updateFindBoard(
            @Part List<MultipartBody.Part> imgFileList,
            @PartMap Map<String, RequestBody> findBoard,
            @Part("imgIndexList") List<Integer> imgIndexList);
...
//    Call<MissingBoard> save(@Body MissingBoard missingBoard);
    ...
    Call<MissingBoard> updateMissingBoard(
            @Part List<MultipartBody.Part> imgFileList,
            @PartMap Map<String, RequestBody> missingBoard,
            @Part("imgIndexList") List<Integer> imgIndexList);
    ...
    Call<StoryBoard> updateStoryBoard(
            @Part List<MultipartBody.Part> imgFileList,
            @PartMap Map<String, RequestBody> storyBoard,
            @Part("imgIndexList") List<Integer> imgIndexList);
