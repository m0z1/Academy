...
public class FindBoardList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button writeMissing = findViewById(R.id.writeFind);
        ...
        binding.member.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FindBoardList.this, MemberInfo.class);
        ...
        writeMissing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(username == "") {
                    ...
                    builder.setMessage("로그인을 해주세요");
                    builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(FindBoardList.this, Login.class);
                            startActivity(intent);
                        }
                    });
                    builder.show();
