...
import com.findpet.project01.databinding.ActivityMissyouBoardBinding;
...
public class MissingBoardActivity extends AppCompatActivity {
    ...
    private ActivityMissyouBoardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMissyouBoardBinding.inflate(getLayoutInflater());
        ...
        binding.home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MissingBoardActivity.this, Main.class);
