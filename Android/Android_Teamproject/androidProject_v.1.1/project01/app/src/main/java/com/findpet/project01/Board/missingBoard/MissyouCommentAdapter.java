...
public class MissyouCommentAdapter extends RecyclerView.Adapter<MissyouCommentAdapter.ViewHolderCmt> {

    List<Comment> commentList;

    public MissyouCommentAdapter(List<Comment> commentList) {
    ...
    @NonNull
    @Override
    public MissyouCommentAdapter.ViewHolderCmt onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_comment, parent, false);
        return new ViewHolderCmt(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MissyouCommentAdapter.ViewHolderCmt holder, int position) {
        Comment comment = commentList.get(position);
        //holder.txmemberid.setText(comment.getMember().getUsername());
        ...
        holder.btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txmemberiddlg = dialogView.findViewById(com.findpet.project01.R.id.txmemberiddlg);
                ...
                dlg.setPositiveButton("수정하기", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Call<Comment> call = commentService.update2(comment1);
        ...
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dlg2.setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        CommentService commentService = CommentClient.getInstance().getCommentService();
                        Call<Void> call = commentService.deleteById2(comment.getCommentId());
