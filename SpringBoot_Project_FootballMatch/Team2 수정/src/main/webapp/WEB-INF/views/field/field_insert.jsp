...
<div class="jumbotron jumbotron-fluid">
	<div class="container con">
		<div class="board_title">구장정보등록</div>
	</div>
</div>
	...
	<form action="/field/field_insert" id="frm" name="frm"
		...
		<div class="d-flex">
			<div class="form-group mr-5">
				...
				<div class="form-group d-flex mb-3">
					<input type="text" name="fieldOpen" autocomplete="off" value="" placeholder="시간선택"
						class="timepicker form-control" required size="8" maxlength="5"
						autocomplete='off' id="fieldOpen" style="width: 150px;"> <input
						type="text" name="fieldClose" value="" autocomplete="off" placeholder="시간선택"
						class="timepicker form-control" required size="8" maxlength="5"
